...
const ExecutiveSummary = () => (
  <section className="px-12 py-14 border-b border-border max-md:px-6 max-md:py-10">
    ...
    <div className="text-[15px] leading-relaxed text-text-sub max-w-[780px] space-y-4">
      <p>
        <T
          es="Trenton Plaza es un centro comercial vecinal de 98,426 pies² en 15.13 acres en Edinburg, Texas, listado por CBRE a un precio total de venta de $12,764,000. El vendedor presenta un cap rate actual de 8.31% basado en un Ingreso Operativo Neto (ION) de $1,019,071. Sin embargo, ese cap rate se calcula únicamente sobre el centro comercial ($12,264,000) — el precio total incluye un terreno adicional de 3.05 acres por $500,000, lo que reduce el cap rate efectivo a 7.98%."
          en="Trenton Plaza is a 98,426 SF neighborhood shopping center on 15.13 acres in Edinburg, Texas, listed by CBRE at a total asking price of $12,764,000. The seller presents an in-place cap rate of 8.31% based on a Net Operating Income of $1,019,071. However, that cap rate is calculated only on the shopping center ($12,264,000) — the total price includes an additional 3.05-acre land parcel at $500,000, which drops the effective cap rate to 7.98%."
        />
      </p>
      <p>
        <T
